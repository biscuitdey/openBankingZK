...
snarkjs zkey new zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot15_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_0000.zkey

## Ceremony just like before but for zkey this time
snarkjs zkey contribute zeroKnowledgeArtifacts/circuits/$1/$1_0000.zkey zeroKnowledgeArtifacts/circuits/$1/$1_0001.zkey \
    --name="First circuit contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
snarkjs zkey contribute zeroKnowledgeArtifacts/circuits/$1/$1_0001.zkey zeroKnowledgeArtifacts/circuits/$1/$1_0002.zkey \
    --name="Second circuit contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"
snarkjs zkey contribute zeroKnowledgeArtifacts/circuits/$1/$1_0002.zkey zeroKnowledgeArtifacts/circuits/$1/$1_0003.zkey \
    --name="Third circuit contribution" -v -e="$(head -n 4096 /dev/urandom | openssl sha1)"

##  Verify if zkey belongs to our specific circuit
snarkjs zkey verify zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot15_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_0003.zkey

## Apply random beacon as before
snarkjs zkey beacon zeroKnowledgeArtifacts/circuits/$1/$1_0003.zkey zeroKnowledgeArtifacts/circuits/$1/$1_final.zkey \
    0102030405060708090a0b0c0d0e0f101112131515161718191a1b1c1d1e1f 10 -n="Circuit FinalBeacon phase2"

## Optional: verify final zkey
snarkjs zkey verify zeroKnowledgeArtifacts/circuits/$1/$1.r1cs zeroKnowledgeArtifacts/ptau/pot15_final.ptau zeroKnowledgeArtifacts/circuits/$1/$1_final.zkey
