...
# Compile circuits
circom src/customerVerifier/service/circuit/snarkjs/$1.circom -o zeroKnowledgeArtifacts/circuits/$1 --r1cs --wasm
...
snarkjs zkey export solidityverifier zeroKnowledgeArtifacts/circuits/$1/$1_final.zkey src/customerVerifier/service/circuit/snarkjs/$1Verifier.sol
